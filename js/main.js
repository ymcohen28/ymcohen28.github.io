...
if (sceen.orientation.type === "landscape-primary" || sceen.orientation.type === "landscape-secondary") {
          console.log("yay");
...
if (sceen.orientation.type !== "landscape-primary" && sceen.orientation.type !== "landscape-secondary") {for (var i = 0; i < realHeader.length;i ++) {  
